...
4. Нэр: `Байгаль орчны хяналтын нэгдсэн систем` → **Save**

   Item-ийн нэр нь зөвхөн порталын доторх шошго — нэвтрэлтэд нөлөөлөхгүй.
   ⚠ Одоо ажиллаж буй бүртгэл нь **`Байгаль орчны нэгдсэн платформ`**
   гэсэн ХУУЧИН нэрээр үүссэн (систем 2026-09-15-нд нэрээ сольсон).
   Порталаас хайхдаа түүгээр хайна.
