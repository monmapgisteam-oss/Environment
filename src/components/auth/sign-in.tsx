...
/* --------------------------------------------------------------------------
   ...
   ⚠ **БИЧВЭР ЗҮҮН ТАЛД СУУНА — ЗУРГААС БОЛЖ.** Одоогийн зураг
   (2800×1300) нь нийслэлийн зураглал, зангилаануудыг өргөний **37%-иас
   баруун тийш** агуулж, зүүн гуравны нэг нь бүдгэрсэн уулархаг дэвсгэр.
   Бичвэр тэр хоосон хэсэгт сууна.
   ...
   ⚠ **ХАЙЧЛАЛТ ГОЛООРОО** (`bg-center`). `bg-cover` нь цонхны харьцаа
   зургийнхаас нарийн байвал илүүдлийг хажуугаас хайчилдаг. Хамгийн
   ноцтой тохиолдол нь MacBook маягийн цонх (1512×860) — хажуугаас 18%,
   хоёр тийш тэнцүү хуваагдаж тал бүрээс 9%. Бичвэрийн блок 380px тул
   1512px өргөн цонхны 28%-ийг эзэлж, зургийн 32%-д тулна — агуулга
   эхлэх 37%-аас хол. Тиймээс бичвэр зураглалыг ХЭЗЭЭ Ч давхарлахгүй.
