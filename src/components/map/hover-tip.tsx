...
export function MapTip({
  ...
  /*
    ⚠⚠ АГУУЛГАГҮЙ ҮЕД ЮУ Ч ЗУРАХГҮЙ.

    Дуудагч тал хоёр хэвээр бичдэг: хамгаалалтыг ГАДНА нь
    (`{hovered ? <MapTip>…</MapTip> : null}`) эсвэл ДОТОР нь
    (`<MapTip>{hovered ? … : null}</MapTip>`). Сүүлийн хэвэнд хайрцаг
    нь хоосон хэвээр зурагдсаар байсан бөгөөд дотор нь `bg-data`
    зураас ганцаараа үлддэг тул газрын зураг дээр **өргөнийхөө
    хэмжээгээр (228–250px) хэвтээ зураас** үлдэж, хулгана зургаас
    гарсан ч арилдаггүй байв (хэрэглэгч 2026-09-17-нд мэдээлсэн:
    ойн давхаргын зураг дээр хиймэл дагуулын дэвсгэр дээр цайвар
    зураас хөндлөн сууж байлаа).

    Засварыг ДУУДАГЧ дээр биш ЭНД хийсэн нь санаатай: аль хэв нь ч
    зөв ажиллах ёстой бөгөөд шинэ самбар нэмэх бүрд дүрмийг санах
    шаардлагагүй.
  */
  ...
  */
  React.useLayoutEffect(() => {
    state.mount(empty ? null : el.current);
