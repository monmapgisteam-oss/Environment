...
export function UnelgeeDashboard() {
  ...
  */
  ...
  /*
    Хугацааны зурвас — СОНГОСОН оны сарууд.

    Түлхүүр нь `"2026-05"` хэлбэрээр он, сар ХОЁУЛАНГ агуулна. Нэг
    оныг харж байхад илүүц мэт ч бүртгэлд өөр оны бичлэг санамсаргүй
    орвол (эх сурвалжийн алдаа) тэр нь тусдаа цэг болж ил гарна —
    зөвхөн сараар бүлэглэвэл чимээгүйхэн нийлнэ.
            ...
            */}
            <Card className="shrink-0">
              <Head title="Шийдвэрлэлтийн урсгал">
                <span className="num text-[10.5px] text-ink-3">{year} он · сараар</span>
              </Head>
              <div className="p-3">
                <AreaChart
                  data={monthData}
                  ...
                  unit="үнэлгээ"
                  /*
                    Тэнхлэгт зөвхөн САРЫН дугаар. Он нь толгойд нэг л
                    удаа бичигдсэн тул цэг бүр дээр давтах нь илүүц
                    бөгөөд бүтэн огноо бичвэл шошго налж, зурвасын
                    өндрийг хоёр дахин иднэ.
                  */
                  formatTick={(d) => String(Number(d.key.slice(5)))}
                />
              </div>
            </Card>
