...
/*
  Хэлтэс хоёр эх сурвалжтай болсон тул самбар хооронд сольж харна.
  ...
  Уур амьсгалын өөрчлөлтийн дата хэлтсээс хараахан ирээгүй — ирэхэд энд
  гурав дахь таб нэмнэ.
*/
const spinner = () => (
